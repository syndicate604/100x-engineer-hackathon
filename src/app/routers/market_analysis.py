...
class ProblemBreakdown(BaseModel):
    ...
    questions: List[str] = Field(..., description="List of sub-problems derived from the main query")
...
class MarketAnalyzer:
    ...
    def breakdown_problem(self, query: str) -> ProblemBreakdown:
        ...
        messages = [
            ...
            """),
            Message(role="user", content=f"Break down this query into detailed sub-problems: {query}")
        ]
    ...
    def generate_search_query(self, question: str) -> str:
        ...
        messages = [
            ...
            """),
            Message(role="user", content=f"Generate a search query to research: {question}")
        ]
    ...
    def compile_comprehensive_report(self):
        ...
        messages = [
            ...
            """),
            Message(role="user", content=f"Original Query: {self.original_query}\nIndividual Reports: {self.reports}")
        ]
